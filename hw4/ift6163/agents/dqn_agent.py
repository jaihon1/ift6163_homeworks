...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        # print("latest_observation_frame", latest_observation_frame.shape)
        # print("storing latest observation frame into the replay buffer")
        ...
        if rand < eps or self.t < self.learning_starts:
