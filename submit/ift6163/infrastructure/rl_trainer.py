...
class RL_Trainer(object):
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['alg']['num_agent_train_steps_per_iter']):
            ...
            ob_batch, ac_batch, re_batch, next_ob_batch, terminal_batch = self.agent.sample(self.params['alg']['train_batch_size'], self.params['alg']['data_ratio'])
