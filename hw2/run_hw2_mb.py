...
# python run_hw2_mb.py exp_name=q4_reacher_horizon15 env_name=reacher-ift6163-v0 add_sl_noise=true mpc_horizon=15 num_agent_train_steps_per_iter=1000 batch_size=800 n_iter=5 video_log_freq=-1 mpc_action_sampling_strategy='random'

# python run_hw2_mb.py exp_name=q4_reacher_horizon30 env_name=reacher-ift6163-v0 add_sl_noise=true mpc_horizon=30 num_agent_train_steps_per_iter=1000 batch_size=800 n_iter=5 video_log_freq=-1 mpc_action_sampling_strategy='random'
